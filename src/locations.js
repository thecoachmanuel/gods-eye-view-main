...
export const CITY_POIS = {
  ...
  nigeria: {
    name: 'Nigeria',
    groundElevation: 300,
    viewBounds: { southwest: { lat: 4.27, lng: 2.68 }, northeast: { lat: 13.89, lng: 14.68 } },
    pois: [
      { name: 'Zuma Rock', lat: 9.1292, lon: 7.2344, alt: 1400, pitch: -20, heading: 180, buildingHeight: 300 },
      { name: 'Aso Rock', lat: 9.0833, lon: 7.5361, alt: 1200, pitch: -25, heading: 210, buildingHeight: 400 },
      { name: 'Lekki-Ikoyi Link Bridge', lat: 6.4474, lon: 3.4419, alt: 600, pitch: -25, heading: 45, buildingHeight: 50 },
      { name: 'National Mosque Abuja', lat: 9.0583, lon: 7.4897, alt: 500, pitch: -25, heading: 0, buildingHeight: 60 },
      { name: 'Eko Atlantic City', lat: 6.4167, lon: 3.4000, alt: 800, pitch: -22, heading: 0, buildingHeight: 60 },
    ],
  },
  lagos: {
    name: 'Lagos',
    groundElevation: 10,
    viewBounds: { southwest: { lat: 6.38, lng: 3.20 }, northeast: { lat: 6.65, lng: 3.65 } },
    pois: [
      { name: 'Lekki-Ikoyi Link Bridge', lat: 6.4474, lon: 3.4419, alt: 600, pitch: -25, heading: 45, buildingHeight: 50 },
      { name: 'Eko Atlantic City', lat: 6.4167, lon: 3.4000, alt: 800, pitch: -22, heading: 0, buildingHeight: 60 },
      { name: 'National Arts Theatre', lat: 6.4770, lon: 3.3693, alt: 500, pitch: -28, heading: 180, buildingHeight: 35 },
      { name: 'Tafawa Balewa Square', lat: 6.4453, lon: 3.4022, alt: 550, pitch: -22, heading: 30, buildingHeight: 40 },
      { name: 'Lekki Conservation Centre', lat: 6.4358, lon: 3.5354, alt: 700, pitch: -30, heading: 90, buildingHeight: 25 },
    ],
  },
  abuja: {
    name: 'Abuja',
    groundElevation: 480,
    viewBounds: { southwest: { lat: 8.90, lng: 7.30 }, northeast: { lat: 9.20, lng: 7.60 } },
    pois: [
      { name: 'Aso Rock', lat: 9.0833, lon: 7.5361, alt: 1200, pitch: -25, heading: 210, buildingHeight: 400 },
      { name: 'National Mosque', lat: 9.0583, lon: 7.4897, alt: 500, pitch: -25, heading: 0, buildingHeight: 60 },
      { name: 'Zuma Rock', lat: 9.1292, lon: 7.2344, alt: 1400, pitch: -20, heading: 180, buildingHeight: 300 },
      { name: 'National Christian Centre', lat: 9.0542, lon: 7.4939, alt: 500, pitch: -25, heading: 45, buildingHeight: 50 },
      { name: 'Millennium Park', lat: 9.0625, lon: 7.5028, alt: 650, pitch: -30, heading: 330, buildingHeight: 20 },
    ],
  },

  // ── Nigerian Regional Cities ─────────────────────────────────────────────
  // Added: Port Harcourt, Kano, Ibadan, Enugu, Benin City, Kaduna, Sokoto,
  // Maiduguri. Each follows the same schema as the existing city presets:
  // groundElevation (meters above WGS84), viewBounds for metro-level fly-to,
  // and 5 hand-tuned POIs with alt (camera range in m), pitch & heading.

  port_harcourt: {
    name: 'Port Harcourt',
    groundElevation: 10,
    viewBounds: { southwest: { lat: 4.70, lng: 6.90 }, northeast: { lat: 4.95, lng: 7.15 } },
    pois: [
      { name: 'Port Harcourt Refinery', lat: 4.8156, lon: 7.0498, alt: 900, pitch: -30, heading: 0, buildingHeight: 40 },
      { name: 'Port Harcourt Port', lat: 4.7765, lon: 7.0203, alt: 700, pitch: -28, heading: 90, buildingHeight: 20 },
      { name: 'Isaac Boro Garden Park', lat: 4.8243, lon: 7.0334, alt: 500, pitch: -30, heading: 180, buildingHeight: 10 },
      { name: 'University of Port Harcourt', lat: 4.8968, lon: 6.9999, alt: 800, pitch: -28, heading: 0, buildingHeight: 20 },
      { name: 'Government House Port Harcourt', lat: 4.8222, lon: 7.0317, alt: 450, pitch: -25, heading: 270, buildingHeight: 25 },
    ],
  },
  kano: {
    name: 'Kano',
    groundElevation: 470,
    viewBounds: { southwest: { lat: 11.90, lng: 8.40 }, northeast: { lat: 12.15, lng: 8.65 } },
    pois: [
      { name: 'Kano Emir Palace', lat: 12.0003, lon: 8.5168, alt: 650, pitch: -28, heading: 180, buildingHeight: 25 },
      { name: 'Gidan Makama Museum', lat: 12.0018, lon: 8.5188, alt: 500, pitch: -25, heading: 90, buildingHeight: 20 },
      { name: 'Kano Dye Pits', lat: 12.0042, lon: 8.5170, alt: 400, pitch: -35, heading: 0, buildingHeight: 5 },
      { name: 'Kano City Wall', lat: 11.9983, lon: 8.5050, alt: 700, pitch: -22, heading: 45, buildingHeight: 10 },
      { name: 'Mallam Aminu Kano Airport', lat: 12.0476, lon: 8.5246, alt: 900, pitch: -30, heading: 270, buildingHeight: 15 },
    ],
  },
  ibadan: {
    name: 'Ibadan',
    groundElevation: 200,
    viewBounds: { southwest: { lat: 7.30, lng: 3.80 }, northeast: { lat: 7.55, lng: 4.05 } },
    pois: [
      { name: 'University of Ibadan', lat: 7.4449, lon: 3.8986, alt: 800, pitch: -28, heading: 0, buildingHeight: 25 },
      { name: 'Cocoa House', lat: 7.3862, lon: 3.8938, alt: 450, pitch: -20, heading: 90, buildingHeight: 40 },
      { name: 'Mapo Hall', lat: 7.3869, lon: 3.8951, alt: 400, pitch: -25, heading: 180, buildingHeight: 30 },
      { name: 'Ibadan Zoo', lat: 7.4314, lon: 3.8923, alt: 600, pitch: -30, heading: 270, buildingHeight: 10 },
      { name: 'Agodi Gardens', lat: 7.4069, lon: 3.8905, alt: 550, pitch: -28, heading: 45, buildingHeight: 15 },
    ],
  },
  enugu: {
    name: 'Enugu',
    groundElevation: 220,
    viewBounds: { southwest: { lat: 6.35, lng: 7.45 }, northeast: { lat: 6.55, lng: 7.65 } },
    pois: [
      { name: 'Enugu Coal Mine', lat: 6.4427, lon: 7.5002, alt: 700, pitch: -28, heading: 90, buildingHeight: 20 },
      { name: 'Government House Enugu', lat: 6.4505, lon: 7.5134, alt: 500, pitch: -25, heading: 180, buildingHeight: 25 },
      { name: 'University of Nigeria Enugu Campus', lat: 6.4614, lon: 7.5563, alt: 650, pitch: -28, heading: 0, buildingHeight: 20 },
      { name: 'Ngwo Pine Forest', lat: 6.5278, lon: 7.4553, alt: 900, pitch: -30, heading: 270, buildingHeight: 30 },
      { name: 'Enugu Polo Club', lat: 6.4380, lon: 7.4918, alt: 550, pitch: -25, heading: 45, buildingHeight: 10 },
    ],
  },
  benin_city: {
    name: 'Benin City',
    groundElevation: 80,
    viewBounds: { southwest: { lat: 6.25, lng: 5.55 }, northeast: { lat: 6.45, lng: 5.75 } },
    pois: [
      { name: 'Benin Royal Palace', lat: 6.3354, lon: 5.6216, alt: 550, pitch: -28, heading: 180, buildingHeight: 20 },
      { name: 'Benin City Walls', lat: 6.3370, lon: 5.6070, alt: 700, pitch: -30, heading: 90, buildingHeight: 8 },
      { name: 'Emotan Statue', lat: 6.3360, lon: 5.6217, alt: 400, pitch: -25, heading: 0, buildingHeight: 10 },
      { name: 'University of Benin', lat: 6.3683, lon: 5.6312, alt: 800, pitch: -28, heading: 270, buildingHeight: 20 },
      { name: 'Igun Street Bronze Casters', lat: 6.3392, lon: 5.6240, alt: 400, pitch: -28, heading: 45, buildingHeight: 10 },
    ],
  },
  kaduna: {
    name: 'Kaduna',
    groundElevation: 610,
    viewBounds: { southwest: { lat: 10.45, lng: 7.35 }, northeast: { lat: 10.65, lng: 7.55 } },
    pois: [
      { name: 'Kaduna Refinery', lat: 10.5694, lon: 7.4011, alt: 900, pitch: -28, heading: 0, buildingHeight: 35 },
      { name: 'Lugard Hall Kaduna', lat: 10.5222, lon: 7.4396, alt: 550, pitch: -25, heading: 180, buildingHeight: 25 },
      { name: 'Kaduna State Government House', lat: 10.5213, lon: 7.4414, alt: 500, pitch: -25, heading: 90, buildingHeight: 20 },
      { name: 'Kaduna Polytechnic', lat: 10.5497, lon: 7.4353, alt: 700, pitch: -28, heading: 270, buildingHeight: 20 },
      { name: 'Crocodile River', lat: 10.5020, lon: 7.4405, alt: 800, pitch: -30, heading: 45, buildingHeight: 5 },
    ],
  },
  sokoto: {
    name: 'Sokoto',
    groundElevation: 270,
    viewBounds: { southwest: { lat: 12.98, lng: 5.15 }, northeast: { lat: 13.13, lng: 5.30 } },
    pois: [
      { name: 'Sokoto Caliphate Palace', lat: 13.0622, lon: 5.2339, alt: 650, pitch: -28, heading: 180, buildingHeight: 20 },
      { name: 'Sultan Bello Mosque', lat: 13.0630, lon: 5.2323, alt: 500, pitch: -25, heading: 0, buildingHeight: 30 },
      { name: 'Shehu Kangiwa Square', lat: 13.0603, lon: 5.2341, alt: 450, pitch: -25, heading: 90, buildingHeight: 10 },
      { name: 'Usmanu Danfodiyo University', lat: 13.0285, lon: 5.2419, alt: 800, pitch: -28, heading: 270, buildingHeight: 20 },
      { name: 'Sokoto State Museum', lat: 13.0601, lon: 5.2359, alt: 450, pitch: -28, heading: 45, buildingHeight: 15 },
    ],
  },
  maiduguri: {
    name: 'Maiduguri',
    groundElevation: 320,
    viewBounds: { southwest: { lat: 11.77, lng: 13.08 }, northeast: { lat: 11.92, lng: 13.23 } },
    pois: [
      { name: 'University of Maiduguri', lat: 11.8333, lon: 13.1517, alt: 900, pitch: -28, heading: 0, buildingHeight: 20 },
      { name: 'Shehu of Borno Palace', lat: 11.8462, lon: 13.1600, alt: 600, pitch: -25, heading: 180, buildingHeight: 20 },
      { name: 'Ramat Square Maiduguri', lat: 11.8453, lon: 13.1517, alt: 550, pitch: -25, heading: 90, buildingHeight: 10 },
      { name: 'Maiduguri Airport', lat: 11.8553, lon: 13.0809, alt: 1000, pitch: -30, heading: 270, buildingHeight: 15 },
      { name: 'Lake Chad Basin Research Institute', lat: 11.8386, lon: 13.1504, alt: 600, pitch: -28, heading: 45, buildingHeight: 15 },
    ],
  },
};
...
/**
 * Attempt to parse a coordinate pair (lat, lon) from free text.
 * Accepts "9.0765, 7.3986", "9.0765 7.3986", "9.0765° N, 7.3986° E", etc.
 * @param {string} text
 * @returns {{lat: number, lon: number} | null}
 */
export function tryParseCoordinates(text) {
  if (!text || typeof text !== 'string') return null;
  const s = text.trim();
  const match = s.match(/^([+-]?\d+(?:\.\d+)?)\s*°?\s*([NS])?[\s,;]+([+-]?\d+(?:\.\d+)?)\s*°?\s*([EW])?$/i);
...
/**
 * Geocode a place name using Google Geocoding API with OpenStreetMap fallback,
 * then fly there at a scale appropriate to the request. Countries and cities
 * use their viewport by default; precise landmarks/buildings use close landmark framing.
 */
export async function searchAndFlyTo(viewer, query, options = {}) {
  ...
  if (coords) {
    result = {
      formatted_address: `${coords.lat.toFixed(4)}, ${coords.lon.toFixed(4)}`,
      geometry: {
        location: { lat: coords.lat, lng: coords.lon },
        viewport: {
          southwest: { lat: coords.lat - 0.01, lng: coords.lon - 0.01 },
          northeast: { lat: coords.lat + 0.01, lng: coords.lon + 0.01 },
        },
      },
  ...
  // 2. Try Google Geocoding API if key is present and coordinates were not provided
  if (!result && apiKey) {
    try {
      ...
      console.warn('[Search] Google geocoding error:', err?.message || err);
    }
  }

  // 3. Fallback to local /api/geocode endpoint (connected to OpenStreetMap Nominatim)
  if (!result) {
    try {
      const bias = viewportBias(viewer);
      let proxyUrl = `/api/geocode?q=${encodeURIComponent(query)}`;
      if (bias) proxyUrl += `&bias=${encodeURIComponent(bias)}`;
      ...
      console.warn('[Search] Local geocode proxy error:', err?.message || err);
    }
  }

  // 4. Fallback to direct public Nominatim if proxy is unavailable
  if (!result) {
    try {
      const directUrl = `https://nominatim.openstreetmap.org/search?q=${encodeURIComponent(query)}&format=json&addressdetails=1&limit=1`;
      const response = await fetch(directUrl, {
        headers: { 'User-Agent': 'gods-eye-view/0.1.1 (https://github.com/bilawalsidhu/gods-eye-view)' },
      });
      if (response.ok) {
        ...
        if (Array.isArray(items) && items.length > 0) {
          ...
          if (Number.isFinite(lat) && Number.isFinite(lng)) {
            ...
            if (Array.isArray(item.boundingbox) && item.boundingbox.length === 4) {
              vp = {
                southwest: { lat: Number(item.boundingbox[0]), lng: Number(item.boundingbox[2]) },
                northeast: { lat: Number(item.boundingbox[1]), lng: Number(item.boundingbox[3]) },
              };
            }
            result = {
              formatted_address: item.display_name || item.name || query,
              geometry: {
                location: { lat, lng },
                viewport: vp || {
              ...
              types: [
                item.addresstype === 'country' ? 'country' : (item.addresstype === 'city' ? 'locality' : 'point_of_interest'),
                'political',
              ],
            };
          }
      ...
      console.warn('[Search] Direct Nominatim fallback error:', err?.message || err);
    }
  }

  // 5. If still no result, check preset POIs or preset cities
  if (!result) {
    ...
    if (poiMatch) {
      ...
      if (poi) {
        result = {
          formatted_address: poi.name,
          geometry: {
            location: { lat: poi.lat, lng: poi.lon },
            viewport: {
              southwest: { lat: poi.lat - 0.01, lng: poi.lon - 0.01 },
              northeast: { lat: poi.lat + 0.01, lng: poi.lon + 0.01 },
            },
          },
  ...
  if (!result) {
    ...
    const matchedCityEntry = Object.entries(CITY_POIS).find(([id, city]) => (
      id.toLowerCase() === normalizedQuery || city.name.toLowerCase() === normalizedQuery
    ));
    if (matchedCityEntry) {
      const [cityId, city] = matchedCityEntry;
      result = {
        formatted_address: city.name,
        geometry: {
          location: { lat: city.pois[0].lat, lng: city.pois[0].lon },
          viewport: city.viewBounds,
          bounds: city.viewBounds,
        },
  ...
  const poiMatch = !explicitOverview ? findPoiByName(query) : null;
  const normalizedQuery = String(query || '').toLowerCase().trim();
  const matchedCityEntry = !explicitOverview ? Object.entries(CITY_POIS).find(([id, city]) => (
    id.toLowerCase() === normalizedQuery || city.name.toLowerCase() === normalizedQuery
  )) : null;
  const presetCity = matchedCityEntry ? matchedCityEntry[1] : (poiMatch ? CITY_POIS[poiMatch.cityId] : null);
  const presetCityId = matchedCityEntry ? matchedCityEntry[0] : (poiMatch ? poiMatch.cityId : null);
  const presetPoi = poiMatch ? presetCity?.pois?.[poiMatch.index] : (presetCity?.pois?.[0] || null);
  ...
  const buildingBounds = (presetPoi?.buildingBounds)
    || (shouldResolveBuilding ? await resolveBuildingBounds(lat, lng, query) : null);
  const targetLat = presetPoi?.lat ?? (buildingBounds?.lat ?? lat);
  const targetLon = presetPoi?.lon ?? (buildingBounds?.lon ?? lng);
  const range = requestedRange
    || presetPoi?.alt
    || defaultRangeForNavigationMode(navigationMode);
  const pitch = presetPoi?.pitch ?? buildingPitch(buildingBounds);
  const heading = presetPoi?.heading ?? 30;
  const buildingHeight = presetPoi?.buildingHeight || 30;
  const groundElevation = presetCity?.groundElevation || 0;
  if (!mayFly()) return CANCELLED_SEARCH;
...
function defaultRangeForNavigationMode(mode) {
  // 3D camera framing ranges: cities and landmarks land with perspective rather than flat nadir.
  if (mode === 'city-overview') return 1000;
  if (mode === 'neighborhood-close') return 600;
