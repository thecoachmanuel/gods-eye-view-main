...
const CAMERA_SEEDS = [
  ...
  { id: 'cctv-los-eko-atlantic', cityId: 'lagos', poiIndex: 1, label: 'Eko Atlantic City (Coastal Way)', offsetNorthM: -80, offsetEastM: 120, headingDeg: 345, fovDeg: 75, rangeM: 750, elevationM: 28 },
  { id: 'cctv-los-national-theatre', cityId: 'lagos', poiIndex: 2, label: 'National Arts Theatre (Iganmu)', offsetNorthM: 60, offsetEastM: 40, headingDeg: 182, fovDeg: 70, rangeM: 600, elevationM: 26 },
  { id: 'cctv-los-tbs-square', cityId: 'lagos', poiIndex: 3, label: 'Tafawa Balewa Square (Outer Ring)', offsetNorthM: -90, offsetEastM: 80, headingDeg: 30, fovDeg: 72, rangeM: 550, elevationM: 25 },
  { id: 'cctv-los-lekki-conservation', cityId: 'lagos', poiIndex: 4, label: 'Lekki Conservation Expressway', offsetNorthM: 120, offsetEastM: -60, headingDeg: 92, fovDeg: 70, rangeM: 650, elevationM: 24 },

  { id: 'cctv-abj-aso-villa', cityId: 'abuja', poiIndex: 0, label: 'Aso Rock Villa (Presidential Overlook)', offsetNorthM: -150, offsetEastM: 80, headingDeg: 208, fovDeg: 76, rangeM: 850, elevationM: 35 },
  { id: 'cctv-abj-national-mosque', cityId: 'abuja', poiIndex: 1, label: 'National Mosque (Independence Ave)', offsetNorthM: 80, offsetEastM: -60, headingDeg: 355, fovDeg: 70, rangeM: 620, elevationM: 24 },
  { id: 'cctv-abj-zuma-rock', cityId: 'abuja', poiIndex: 2, label: 'Zuma Rock Overlook Highway', offsetNorthM: -120, offsetEastM: 100, headingDeg: 182, fovDeg: 78, rangeM: 920, elevationM: 26 },
  { id: 'cctv-abj-national-christian-centre', cityId: 'abuja', poiIndex: 3, label: 'National Christian Centre Plaza', offsetNorthM: 90, offsetEastM: 50, headingDeg: 48, fovDeg: 68, rangeM: 580, elevationM: 22 },
  { id: 'cctv-abj-millennium-park', cityId: 'abuja', poiIndex: 4, label: 'Millennium Park (Shehu Shagari Way)', offsetNorthM: -70, offsetEastM: -90, headingDeg: 328, fovDeg: 72, rangeM: 650, elevationM: 25 },

  { id: 'cctv-phc-refinery', cityId: 'port_harcourt', poiIndex: 0, label: 'Port Harcourt Refinery Gate', offsetNorthM: 110, offsetEastM: -70, headingDeg: 5, fovDeg: 72, rangeM: 750, elevationM: 30 },
  { id: 'cctv-phc-marine-base', cityId: 'port_harcourt', poiIndex: 1, label: 'Port Harcourt Port (Marine Base)', offsetNorthM: -90, offsetEastM: 80, headingDeg: 88, fovDeg: 74, rangeM: 650, elevationM: 24 },
  { id: 'cctv-phc-isaac-boro', cityId: 'port_harcourt', poiIndex: 2, label: 'Isaac Boro Garden Park (Aba Road)', offsetNorthM: 70, offsetEastM: 40, headingDeg: 182, fovDeg: 68, rangeM: 540, elevationM: 22 },

  { id: 'cctv-kano-emir-palace', cityId: 'kano', poiIndex: 0, label: 'Kano Emir Palace (Kofar Kudu)', offsetNorthM: -80, offsetEastM: 60, headingDeg: 180, fovDeg: 72, rangeM: 580, elevationM: 24 },
  { id: 'cctv-kano-gidan-makama', cityId: 'kano', poiIndex: 1, label: 'Gidan Makama Museum Square', offsetNorthM: 90, offsetEastM: -50, headingDeg: 92, fovDeg: 68, rangeM: 500, elevationM: 20 },
  { id: 'cctv-kano-makia-airport', cityId: 'kano', poiIndex: 4, label: 'Mallam Aminu Kano Airport Concourse', offsetNorthM: 120, offsetEastM: 80, headingDeg: 268, fovDeg: 72, rangeM: 750, elevationM: 28 },

  { id: 'cctv-ibd-cocoa-house', cityId: 'ibadan', poiIndex: 1, label: 'Cocoa House (Dugbe Hub)', offsetNorthM: 70, offsetEastM: -40, headingDeg: 88, fovDeg: 70, rangeM: 550, elevationM: 35 },
  { id: 'cctv-ibd-mapo-hall', cityId: 'ibadan', poiIndex: 2, label: 'Mapo Hall (Bere Roundabout)', offsetNorthM: -80, offsetEastM: 60, headingDeg: 182, fovDeg: 75, rangeM: 620, elevationM: 25 },
  { id: 'cctv-ibd-ui-main-gate', cityId: 'ibadan', poiIndex: 0, label: 'University of Ibadan Main Gate', offsetNorthM: 100, offsetEastM: 60, headingDeg: 2, fovDeg: 72, rangeM: 650, elevationM: 22 },

  { id: 'cctv-enu-okpara-square', cityId: 'enugu', poiIndex: 0, label: 'Okpara Square (Independence Layout)', offsetNorthM: -90, offsetEastM: 70, headingDeg: 88, fovDeg: 72, rangeM: 580, elevationM: 24 },
  { id: 'cctv-enu-gov-house', cityId: 'enugu', poiIndex: 1, label: 'Enugu Government House Gate', offsetNorthM: 80, offsetEastM: -50, headingDeg: 178, fovDeg: 68, rangeM: 520, elevationM: 22 },

  { id: 'cctv-ben-royal-palace', cityId: 'benin_city', poiIndex: 0, label: 'Benin Royal Palace (King\'s Square)', offsetNorthM: -70, offsetEastM: 50, headingDeg: 182, fovDeg: 74, rangeM: 620, elevationM: 24 },
  { id: 'cctv-ben-uniben-ugbowo', cityId: 'benin_city', poiIndex: 3, label: 'UNIBEN Main Gate (Ugbowo)', offsetNorthM: 100, offsetEastM: -60, headingDeg: 268, fovDeg: 70, rangeM: 640, elevationM: 22 },

  { id: 'cctv-kad-ahmadu-bello', cityId: 'kaduna', poiIndex: 0, label: 'Kaduna Ahmadu Bello Way (Central)', offsetNorthM: 110, offsetEastM: -70, headingDeg: 180, fovDeg: 70, rangeM: 580, elevationM: 24 },
  { id: 'cctv-kad-lugard-hall', cityId: 'kaduna', poiIndex: 1, label: 'Lugard Hall (Independence Way)', offsetNorthM: -80, offsetEastM: 60, headingDeg: 182, fovDeg: 72, rangeM: 600, elevationM: 25 },

  { id: 'cctv-sok-sultan-palace', cityId: 'sokoto', poiIndex: 0, label: 'Sokoto Sultan Palace (Kofar Rini)', offsetNorthM: -70, offsetEastM: 50, headingDeg: 180, fovDeg: 70, rangeM: 580, elevationM: 22 },
  { id: 'cctv-mai-shehu-palace', cityId: 'maiduguri', poiIndex: 1, label: 'Shehu of Borno Palace (Main Plaza)', offsetNorthM: 90, offsetEastM: -60, headingDeg: 270, fovDeg: 70, rangeM: 600, elevationM: 22 },
];
