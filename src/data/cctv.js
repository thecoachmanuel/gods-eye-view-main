...
const CAMERA_SEEDS = [
  ...
  // Nigeria Camera Seeds (dynamically routed through live surveillance proxy)
  { id: 'cctv-los-apapa-port', cityId: 'lagos', poiIndex: 3, label: 'Apapa Port (Commercial Road Terminal Gate)', offsetNorthM: -450, offsetEastM: -950, headingDeg: 95, fovDeg: 70, rangeM: 580, elevationM: 28, provider: 'NPA Port Security Command', poseSource: 'curated' },
  { id: 'cctv-los-tin-can-island', cityId: 'lagos', poiIndex: 3, label: 'Tin Can Island Port (Express Access Gate)', offsetNorthM: -200, offsetEastM: -1800, headingDeg: 120, fovDeg: 72, rangeM: 620, elevationM: 26, provider: 'NPA Port Security Command', poseSource: 'curated' },
  { id: 'cctv-los-lekki-ikoyi-north', cityId: 'lagos', poiIndex: 0, label: 'Lekki-Ikoyi Link Bridge (North Pylon)', offsetNorthM: 100, offsetEastM: -50, headingDeg: 42, fovDeg: 68, rangeM: 580, elevationM: 32, provider: 'LASTMA Traffic Surveillance', poseSource: 'curated' },
  { id: 'cctv-los-marina-cms', cityId: 'lagos', poiIndex: 3, label: 'Marina Waterfront (CMS Bus Terminal)', offsetNorthM: 80, offsetEastM: -120, headingDeg: 145, fovDeg: 70, rangeM: 550, elevationM: 24, provider: 'LASWA Waterways Command', poseSource: 'curated' },
  { id: 'cctv-los-eko-atlantic', cityId: 'lagos', poiIndex: 1, label: 'Eko Atlantic City (Coastal Way)', offsetNorthM: -80, offsetEastM: 120, headingDeg: 345, fovDeg: 75, rangeM: 750, elevationM: 28, provider: 'Eko Atlantic Command', poseSource: 'curated' },
  { id: 'cctv-los-national-theatre', cityId: 'lagos', poiIndex: 2, label: 'National Arts Theatre (Iganmu)', offsetNorthM: 60, offsetEastM: 40, headingDeg: 182, fovDeg: 70, rangeM: 600, elevationM: 26, provider: 'LASTMA Traffic Surveillance', poseSource: 'curated' },
  { id: 'cctv-los-tbs-square', cityId: 'lagos', poiIndex: 3, label: 'Tafawa Balewa Square (Outer Ring)', offsetNorthM: -90, offsetEastM: 80, headingDeg: 30, fovDeg: 72, rangeM: 550, elevationM: 25, provider: 'Lagos State Security Trust', poseSource: 'curated' },
  { id: 'cctv-los-lekki-conservation', cityId: 'lagos', poiIndex: 4, label: 'Lekki Conservation Expressway', offsetNorthM: 120, offsetEastM: -60, headingDeg: 92, fovDeg: 70, rangeM: 650, elevationM: 24, provider: 'LASTMA Traffic Surveillance', poseSource: 'curated' },
  { id: 'cctv-los-tmb-adekunle', cityId: 'lagos', poiIndex: 2, label: 'Third Mainland Bridge (Adekunle Interchange)', offsetNorthM: 450, offsetEastM: 600, headingDeg: 88, fovDeg: 72, rangeM: 680, elevationM: 26, provider: 'LASTMA Expressway Command', poseSource: 'curated' },
  { id: 'cctv-los-mma-intl', cityId: 'lagos', poiIndex: 2, label: 'Murtala Muhammed Intl Airport (Terminal Approach)', offsetNorthM: 1800, offsetEastM: -350, headingDeg: 235, fovDeg: 74, rangeM: 720, elevationM: 30, provider: 'FAAN Aviation Security (AVSEC)', poseSource: 'curated' },

  { id: 'cctv-abj-aso-villa', cityId: 'abuja', poiIndex: 0, label: 'Aso Rock Villa (Presidential Overlook)', offsetNorthM: -150, offsetEastM: 80, headingDeg: 208, fovDeg: 76, rangeM: 850, elevationM: 35, provider: 'Presidency Security Command', poseSource: 'curated' },
  { id: 'cctv-abj-national-mosque', cityId: 'abuja', poiIndex: 1, label: 'National Mosque (Independence Ave)', offsetNorthM: 80, offsetEastM: -60, headingDeg: 355, fovDeg: 70, rangeM: 620, elevationM: 24, provider: 'FCTA City Surveillance', poseSource: 'curated' },
  { id: 'cctv-abj-zuma-rock', cityId: 'abuja', poiIndex: 2, label: 'Zuma Rock Overlook Highway', offsetNorthM: -120, offsetEastM: 100, headingDeg: 182, fovDeg: 78, rangeM: 920, elevationM: 26, provider: 'Federal Highway Patrol', poseSource: 'curated' },
  { id: 'cctv-abj-national-christian-centre', cityId: 'abuja', poiIndex: 3, label: 'National Christian Centre Plaza', offsetNorthM: 90, offsetEastM: 50, headingDeg: 48, fovDeg: 68, rangeM: 580, elevationM: 22, provider: 'FCTA City Surveillance', poseSource: 'curated' },
  { id: 'cctv-abj-millennium-park', cityId: 'abuja', poiIndex: 4, label: 'Millennium Park (Shehu Shagari Way)', offsetNorthM: -70, offsetEastM: -90, headingDeg: 328, fovDeg: 72, rangeM: 650, elevationM: 25, provider: 'FCTA City Surveillance', poseSource: 'curated' },

  { id: 'cctv-phc-refinery', cityId: 'port_harcourt', poiIndex: 0, label: 'Port Harcourt Refinery Gate', offsetNorthM: 110, offsetEastM: -70, headingDeg: 5, fovDeg: 72, rangeM: 750, elevationM: 30, provider: 'NNPC Industrial Security', poseSource: 'curated' },
  { id: 'cctv-phc-marine-base', cityId: 'port_harcourt', poiIndex: 1, label: 'Port Harcourt Port (Marine Base)', offsetNorthM: -90, offsetEastM: 80, headingDeg: 88, fovDeg: 74, rangeM: 650, elevationM: 24, provider: 'NPA Eastern Ports Security', poseSource: 'curated' },
  { id: 'cctv-phc-isaac-boro', cityId: 'port_harcourt', poiIndex: 2, label: 'Isaac Boro Garden Park (Aba Road)', offsetNorthM: 70, offsetEastM: 40, headingDeg: 182, fovDeg: 68, rangeM: 540, elevationM: 22, provider: 'Rivers State Security Surveillance', poseSource: 'curated' },

  { id: 'cctv-kano-emir-palace', cityId: 'kano', poiIndex: 0, label: 'Kano Emir Palace (Kofar Kudu)', offsetNorthM: -80, offsetEastM: 60, headingDeg: 180, fovDeg: 72, rangeM: 580, elevationM: 24, provider: 'Kano Municipal Surveillance', poseSource: 'curated' },
  { id: 'cctv-kano-gidan-makama', cityId: 'kano', poiIndex: 1, label: 'Gidan Makama Museum Square', offsetNorthM: 90, offsetEastM: -50, headingDeg: 92, fovDeg: 68, rangeM: 500, elevationM: 20, provider: 'Kano Municipal Surveillance', poseSource: 'curated' },
  { id: 'cctv-kano-makia-airport', cityId: 'kano', poiIndex: 4, label: 'Mallam Aminu Kano Airport Concourse', offsetNorthM: 120, offsetEastM: 80, headingDeg: 268, fovDeg: 72, rangeM: 750, elevationM: 28, provider: 'FAAN Aviation Security (AVSEC)', poseSource: 'curated' },

  { id: 'cctv-ibd-cocoa-house', cityId: 'ibadan', poiIndex: 1, label: 'Cocoa House (Dugbe Hub)', offsetNorthM: 70, offsetEastM: -40, headingDeg: 88, fovDeg: 70, rangeM: 550, elevationM: 35, provider: 'Oyo State Security Network', poseSource: 'curated' },
  { id: 'cctv-ibd-mapo-hall', cityId: 'ibadan', poiIndex: 2, label: 'Mapo Hall (Bere Roundabout)', offsetNorthM: -80, offsetEastM: 60, headingDeg: 182, fovDeg: 75, rangeM: 620, elevationM: 25, provider: 'Oyo State Security Network', poseSource: 'curated' },
  { id: 'cctv-ibd-ui-main-gate', cityId: 'ibadan', poiIndex: 0, label: 'University of Ibadan Main Gate', offsetNorthM: 100, offsetEastM: 60, headingDeg: 2, fovDeg: 72, rangeM: 650, elevationM: 22, provider: 'Oyo State Security Network', poseSource: 'curated' },

  { id: 'cctv-enu-okpara-square', cityId: 'enugu', poiIndex: 0, label: 'Okpara Square (Independence Layout)', offsetNorthM: -90, offsetEastM: 70, headingDeg: 88, fovDeg: 72, rangeM: 580, elevationM: 24, provider: 'Enugu Homeland Security Command', poseSource: 'curated' },
  { id: 'cctv-enu-gov-house', cityId: 'enugu', poiIndex: 1, label: 'Enugu Government House Gate', offsetNorthM: 80, offsetEastM: -50, headingDeg: 178, fovDeg: 68, rangeM: 520, elevationM: 22, provider: 'Enugu Homeland Security Command', poseSource: 'curated' },

  { id: 'cctv-ben-royal-palace', cityId: 'benin_city', poiIndex: 0, label: 'Benin Royal Palace (King\'s Square)', offsetNorthM: -70, offsetEastM: 50, headingDeg: 182, fovDeg: 74, rangeM: 620, elevationM: 24, provider: 'Edo State Command', poseSource: 'curated' },
  { id: 'cctv-ben-uniben-ugbowo', cityId: 'benin_city', poiIndex: 3, label: 'UNIBEN Main Gate (Ugbowo)', offsetNorthM: 100, offsetEastM: -60, headingDeg: 268, fovDeg: 70, rangeM: 640, elevationM: 22, provider: 'Edo State Command', poseSource: 'curated' },

  { id: 'cctv-kad-ahmadu-bello', cityId: 'kaduna', poiIndex: 0, label: 'Kaduna Ahmadu Bello Way (Central)', offsetNorthM: 110, offsetEastM: -70, headingDeg: 180, fovDeg: 70, rangeM: 580, elevationM: 24, provider: 'Kaduna State Surveillance', poseSource: 'curated' },
  { id: 'cctv-kad-lugard-hall', cityId: 'kaduna', poiIndex: 1, label: 'Lugard Hall (Independence Way)', offsetNorthM: -80, offsetEastM: 60, headingDeg: 182, fovDeg: 72, rangeM: 600, elevationM: 25, provider: 'Kaduna State Surveillance', poseSource: 'curated' },

  { id: 'cctv-sok-sultan-palace', cityId: 'sokoto', poiIndex: 0, label: 'Sokoto Sultan Palace (Kofar Rini)', offsetNorthM: -70, offsetEastM: 50, headingDeg: 180, fovDeg: 70, rangeM: 580, elevationM: 22, provider: 'Sokoto State Command', poseSource: 'curated' },
  { id: 'cctv-mai-shehu-palace', cityId: 'maiduguri', poiIndex: 1, label: 'Shehu of Borno Palace (Main Plaza)', offsetNorthM: 90, offsetEastM: -60, headingDeg: 270, fovDeg: 70, rangeM: 600, elevationM: 22, provider: 'Borno State Security Command', poseSource: 'curated' },
];
