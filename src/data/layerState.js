...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ id: 'local-nigeria-incidents', token: 'j', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-nigeria-oil', token: 'o', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-nigeria-states', token: 'n', disposition: 'enabled-only' }),
